              ...
              <div class="card" style="width: 22rem;">
                  ...
                  <div class="card-body">
                      ...
                      <form action="{{ route('perfil.destroy', Auth::user()->id)}}" method="post">
                          @csrf
                          @method('DELETE')
                          <button id="confirm_delete" class="btn btn-secundary" type="submit"
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            @endif
            <td style="width:20%;"><a href="#" data-toggle="modal" data-target="#exampleModal{{$ticket->id}}"><img src="{{ asset($ticket->codi_qr) }}" style="width:20%"></a></td>
            <!-- MODAL QR -->
              ...
              <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <a href="{{ action('PerfilController@imgDownload',$ticket->id)}}" class="btn btn-primary">Descarregar</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          @empty
          <p style="background-color: #e05e5e;text-align: center;font-weight: bold;"> No tens cap ticket actiu</p>
          @endforelse
        </tbody>
      </table>
      <!-- END TICKETS -->
          ...
          <div class="modal fade" id="modalFoto{{$image->id}}" tabindex="-1" role="dialog" aria-labelledby="modalFoto" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                  <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <a href="{{ action('PerfilController@imgDownload',$image->id)}}" class="btn btn-primary">Descarregar</a>
                      </div>
                  </div>
              </div>
          </div>
